...
<div class="content-body">
    <div class="container-fluid">
        <div class="row page-titles">
            <ol class="breadcrumb">
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Tabel History AC</a></li>
                                    ...
                                    <form action="" method="post">
                                        <div class="mb-3 row">
                                            <div class="col-sm-6">
                                                ...
                                                <input type="text" name="id_ac" value="<?=$this->input->post('id_ac') ?? $row->id_ac?>" class="form-control" readonly>
                                            </div>
                                            <div class="col-sm-6">
