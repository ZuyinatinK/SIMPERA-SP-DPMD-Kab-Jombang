    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0)">AC</a></li>
            </ol>
        </div>
        <!-- row -->
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div>
                        <h4 class="card-title">Tabel AC</h4>
                    </div>
                        ...
                        <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <?php echo form_open_multipart('tabelAC/tambah')?>
                                        <div class="modal-header">
                                            <h5 class="modal-title">Data AC</h5>
                        ...
                        <table id="example3" class="display" style="min-width: 845px">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a href="<?= base_url();?>tabelAC/edit/<?= $ac['id'];?>"
                                                class="btn btn-primary shadow btn-xs sharp me-1"><i
                                                    class="fas fa-pencil-alt"></i></a>
                                            <a href="<?= base_url();?>tabelAC/hapus/<?= $ac['id'];?>"
                ...
                <div class="card-header">
                    ...
                    <div>
                        ...
                        <div class="modal fade bd-example-modal-lg1" tabindex="-1" role="dialog" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <form method="POST" action="<?= base_url('tabelAC/tambahHistory')?>">
                                        <div class="modal-header">
                                                ...
                                                <div class="mb-3 row">
                                                    <div class="col-sm-6">
                                                        <select class="default-select form-control wide mb-3" id="id_AC"
                                                            name="id_ac">
                                                            <?php foreach ($tbac as $kua2) : ?>
                                                            <option value="<?php echo $kua2['no_registrasi']; ?>">
                                                                <?php echo $kua2['no_registrasi']; ?>
                                                            </option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                        <?= form_error('kode_barang', '<small class="text-danger pl-3">','</small>');?>
                                                    ...
                                                    <div class="col-sm-6 mt-2 mt-sm-0">
                                                        <input name="service" class="default-select form-control wide mb-3" placeholder="Service">
                                                    </div>
                                                    <div class="col-sm-6 mt-2 mt-sm-0">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="example3" class="display" style="min-width: 845px">
                            ...
                            <tbody>
                                <?php foreach ($historyac as $hstac) : ?>
                                <tr>
                                    <td><?php echo $hstac['id_ac']; ?></td>
                                    <td><?php echo $hstac['service']; ?></td>
                                    <td><?php echo $hstac['history']; ?></td>
                                    <td>
                                        <div class="d-flex">
                                            <a href="<?= base_url();?>tabelAC/editHistory/<?= $hstac['id'];?>"
                                                class="btn btn-primary shadow btn-xs sharp me-1"><i
                                                    class="fas fa-pencil-alt"></i></a>
                                            <a href="<?= base_url();?>tabelAC/hapusHistory/<?= $hstac['id'];?>"
                                                class="btn btn-danger shadow btn-xs sharp"><i
                                                    class="fa fa-trash"></i></a>
                                        </div>
                                    </td>
